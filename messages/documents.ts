export const documentMessages = {
  en: {
    ...
    storageLimit: 'Your company storage is full. Remove unneeded drafts or ask the owner to update the plan.',
    exportLimit: 'Your company has reached its monthly export allowance. Existing exports remain available.',
    billingUnavailable: 'Usage limits are temporarily unavailable. Please try again.',
  ...
  de: {
    ...
    storageLimit: 'Der Unternehmensspeicher ist voll. Löschen Sie nicht benötigte Entwürfe oder ändern Sie den Tarif.',
    exportLimit: 'Das monatliche Exportkontingent ist erreicht. Bestehende Exporte bleiben verfügbar.',
    billingUnavailable: 'Nutzungslimits sind vorübergehend nicht verfügbar. Bitte erneut versuchen.',
    conflict:
